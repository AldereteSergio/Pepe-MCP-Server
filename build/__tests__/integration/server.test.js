...
describe("MCP Server Integration", () => {
    ...
    describe("End-to-end workflows", () => {
        ...
        it("should handle documentation lookup workflow", async () => {
            ...
            const result = await searchEngine.performSearch("Documentation for React hooks: focus on performance");
            expect(result).toBe("Documentation for React hooks");
            expect(searchEngine.performSearch).toHaveBeenCalledWith("Documentation for React hooks: focus on performance");
        });
        it("should handle API discovery workflow", async () => {
            ...
            const result = await searchEngine.performSearch("Find APIs for image recognition: prefer free tier options");
            expect(result).toBe("APIs for image recognition");
            expect(searchEngine.performSearch).toHaveBeenCalledWith("Find APIs for image recognition: prefer free tier options");
        });
        it("should handle deprecated code checking workflow", async () => {
            ...
            const result = await searchEngine.performSearch("Check if this code is deprecated: componentWillMount()");
            expect(result).toBe("componentWillMount is deprecated");
            expect(searchEngine.performSearch).toHaveBeenCalledWith("Check if this code is deprecated: componentWillMount()");
        });
    });

...
describe("Puppeteer Logic Utilities", () => {
    ...
    describe("URL Validation", () => {
        ...
        it("should validate navigation failures", async () => {
            ...
            expect(isNavigationFailure("https://www.perplexity.ai/", "https://www.perplexity.ai/")).toBe(false);
            expect(isNavigationFailure("https://www.perplexity.ai/", "https://wrong-domain.com/")).toBe(true);
        });
    });

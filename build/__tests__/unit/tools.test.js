...
describe("Tools", () => {
    ...
    describe("chatPerplexity", () => {
        it("should handle basic chat functionality with new chat_id", async () => {
            ...
            const result = await chatPerplexity(args, mockCtx, mockPerformSearch, mockGetChatHistory, mockSaveChatMessage);
            expect(mockGetChatHistory).toHaveBeenCalled();
            expect(mockSaveChatMessage).toHaveBeenCalled();
            expect(mockPerformSearch).toHaveBeenCalledWith(expect.stringContaining("Hello, world!"), mockCtx, undefined, undefined);
        ...
        it("should handle chat with existing chat_id and history", async () => {
            ...
            expect(mockPerformSearch).toHaveBeenCalledWith(expect.stringContaining("Previous message"), mockCtx, undefined, undefined);
    ...
    describe("search", () => {
        it("should handle normal detail level search", async () => {
            ...
            const args = { query: "test query", detail_level: "normal" };
            const result = await search(args, mockCtx, mockPerformSearch);
            expect(mockPerformSearch).toHaveBeenCalledWith("test query", mockCtx, undefined, undefined);
        ...
        it("should handle brief detail level search", async () => {
            ...
            const args = { query: "test query", detail_level: "brief" };
            const result = await search(args, mockCtx, mockPerformSearch);
            expect(mockPerformSearch).toHaveBeenCalledWith("test query", mockCtx, undefined, undefined);
        ...
        it("should handle detailed detail level search", async () => {
            ...
            const args = { query: "test query", detail_level: "detailed" };
            const result = await search(args, mockCtx, mockPerformSearch);
            expect(mockPerformSearch).toHaveBeenCalledWith("test query", mockCtx, undefined, undefined);
    ...
    describe("getDocumentation", () => {
        it("should handle basic documentation query", async () => {
            ...
            expect(mockPerformSearch).toHaveBeenCalledWith("React hooks", mockCtx);
    ...
    describe("findApis", () => {
        it("should handle API discovery query", async () => {
            ...
            expect(mockPerformSearch).toHaveBeenCalledWith("image recognition", mockCtx);
    ...
    describe("checkDeprecatedCode", () => {
        it("should handle deprecated code checking", async () => {
            ...
            expect(mockPerformSearch).toHaveBeenCalledWith("componentWillMount()", mockCtx);

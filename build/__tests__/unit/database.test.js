...
describe("DatabaseManager", () => {
    ...
    describe("initialize", () => {
        ...
        it("should handle initialization errors", () => {
            ...
            expect(mockLogError).toHaveBeenCalledWith("DatabaseManager initialization failed:", expect.any(Object));
        });
    });
    describe("getChatHistory", () => {
        ...
        it("should throw error when not initialized", () => {
            ...
            expect(() => uninitializedManager.getChatHistory("test-chat")).toThrow("Database not initialized");
        });
    ...
    describe("saveChatMessage", () => {
        ...
        it("should throw error when not initialized", () => {
            const uninitializedManager = new DatabaseManager();
            expect(() => uninitializedManager.saveChatMessage("chat", "user", "message")).toThrow("Database not initialized");
        });
    });
    describe("close", () => {
